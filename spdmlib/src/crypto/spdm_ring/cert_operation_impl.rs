...
// SPDM EKU OIDs
static EKU_SPDM_REQUESTER_AUTH: &[u8] = &[0x2B, 0x06, 0x01, 0x04, 0x01, 0x83, 0x1C, 0x82, 0x12, 0x02];
static EKU_SPDM_RESPONDER_AUTH: &[u8] = &[0x2B, 0x06, 0x01, 0x04, 0x01, 0x83, 0x1C, 0x82, 0x12, 0x03];
