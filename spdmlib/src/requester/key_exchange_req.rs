...
impl RequesterContext {
    ...
    pub async fn send_receive_spdm_key_exchange(
        ...
        let (req_session_id, key_exchange_context, send_used) =
            self.init_spdm_key_exchange(slot_id, measurement_summary_hash_type, &mut send_buffer)?;
